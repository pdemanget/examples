...
/**
 * http://stackoverflow.com/questions/29482534/how-can-i-use-javafx-to-play-video-on-3d-shape
 */
// Display a rotating 3D box with a video projected onto its surface.
public class ThreeDMedia2 extends Application {

    //private static final String MEDIA_URL = "http://download.oracle.com/otndocs/products/javafx/oow2010-2.flv";
    private static final String MEDIA_URL = "http://www.w3schools.com/html/movie.mp4";
    ...
    public void start(Stage stage) {
        ...
        //Sphere box = new Box(MEDIA_W, MEDIA_H, MEDIA_W);
        Sphere box = new Sphere( MEDIA_H);
